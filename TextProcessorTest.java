...
public class TextProcessorTest {
	...
	public void testSpecial(){
		TextProcessor tp = new TextProcessor("aaaa sen 1, sen2. 44.5 555.32. ddd. U.S.  I am at U.S, i.e.");
		tp.preProcessSepcialCases(tp.getText());
		assertEquals("aaaa sen 1, sen2. 44@#@#5 555@#@#32. ddd. U@#@#S@#@#  I am at U.S, i@#@#e@#@#", tp.getText());
				
	}
	
	@Test
	public void isCorrect_forTextParser() throws textNotParsedException {
		TextProcessor tp1 = new TextProcessor("U.S. i.e. 44.5 is a country, this is sentence 1. Sentence 2 ! Sentence 3 ? Sentence 4");
		tp1.parseTextIntoWords();
		assertEquals(4, tp1.getParsedText().size());
		assertEquals("U.S.", tp1.getParsedText().get(0)[0]);
